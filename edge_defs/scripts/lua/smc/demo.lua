...
local style = require("smc.style")
local overview = require("smc.overview")
local calculator = require("smc.calculator")
local node_editor = require("smc.node_editor")
...
function SMC_SetContext(ctx_in)
   ctx = nk.init_from_ptr(ctx_in);
end
