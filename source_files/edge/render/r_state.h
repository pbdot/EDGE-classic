...
class RenderState
{
  public:
    ...
    virtual void ColorMask(GLboolean r, GLboolean g, GLboolean b, GLboolean a) = 0;

    virtual void Clear(GLbitfield bits) = 0;

    virtual void Flush() = 0;

    virtual void ReadScreen(int x, int y, int w, int h, uint8_t *rgb_buffer) = 0;
