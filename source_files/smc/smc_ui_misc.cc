...
UI_ScaleDialog::UI_ScaleDialog() : UI_Escapable_Window(360, 270, "Scale Objects"), want_close(false)
{
#ifdef _FLTK_DISABLED
...
UI_RotateDialog::UI_RotateDialog() : UI_Escapable_Window(360, 200, "Rotate Objects"), want_close(false)
{
#ifdef _FLTK_DISABLED
...
UI_JumpToDialog::UI_JumpToDialog(const char *_objname, int _limit)
    : UI_Escapable_Window(360, 175, "Jump To Object"), want_close(false), limit(_limit), result(-1)
{
#ifdef _FLTK_DISABLED
    SYS_ASSERT(limit >= 0);
...
void UI_JumpToDialog::input_callback(Fl_Widget *w, void *data)
{
    ...
    bool was_enter = (Fl::event_key() == FL_Enter || Fl::event_key() == FL_KP_Enter);
