...
class Thing
{
  ...
  public:
    Thing()
        : raw_x(0), raw_y(0), angle(0), type(0), options(0), raw_h(0), tid(0), special(0), arg1(0), arg2(0), arg3(0),
          arg4(0), arg5(0)
    {
    }
    ...
    {
        raw_x = MakeValidCoord(x);
    }
    void SetRawY(double y)
    {
        raw_y = MakeValidCoord(y);
    }
    void SetRawH(double h)
    {
        raw_h = MakeValidCoord(h);
    }
...
class Sector
{
  ...
  public:
    Sector() : floorh(0), ceilh(0), floor_tex(0), ceil_tex(0), light(0), type(0), tag(0)
    {
    }
...
class SideDef
{
  ...
  public:
    SideDef() : x_offset(0), y_offset(0), upper_tex(0), mid_tex(0), lower_tex(0), sector(0)
    {
    }
...
class LineDef
{
  ...
  public:
    LineDef() : start(0), end(0), right(-1), left(-1), flags(0), type(0), tag(0), arg2(0), arg3(0), arg4(0), arg5(0)
    {
    }
