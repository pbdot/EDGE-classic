...
#include "smc_e_checks.h"
#include "smc_e_cutpaste.h"
    ...
    : UI_Escapable_Window(W, H, L), want_close(false), user_action(CKR_OK), worst_severity(0)
{
...

    {
...

        {
            ...
            ok_but = new Fl_Button(w() / 2 - but_W / 2, ey + 18, but_W, 34, all_mode ? "Continue" : "OK");
            ok_but->labelfont(1);
...
#ifdef _FLTK_DISABLED
void UI_Check_base::AddLine(const char *msg, int severity, int W, const char *button1, Fl_Callback *cb1,
                            const char *button2, Fl_Callback *cb2, const char *button3, Fl_Callback *cb3)
{
    int cx = 30;
...
check_result_e UI_Check_base::Run()
{
    ...
    case 0:
        return CKR_OK;
    case 1:
        return CKR_MinorProblem;
    default:
        return CKR_MajorProblem;
    }
#else
    return CKR_OK;
#endif
...
{
  public:
    UI_Check_Vertices(bool all_mode) : UI_Check_base(520, 224, all_mode, "Check : Vertices", "Vertex test results")
    {
    }
...
check_result_e CHECK_Vertices(int min_severity = 0)
{
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 2, 210, "Show", &UI_Check_Vertices::action_highlight, "Merge",
                            &UI_Check_Vertices::action_merge);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 2, 210, "Show", &UI_Check_Vertices::action_show_danglers);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 1, 210, "Show", &UI_Check_Vertices::action_show_unused, "Remove",
                            &UI_Check_Vertices::action_remove);
        }
#endif
...
void Sectors_FindUnclosed(selection_c &secs, selection_c &verts)
{
    ...
    for (int s = 0; s < NumSectors; s++)
    {
        ...
        for (int i = 0; i < NumLineDefs; i++)
        {
            ...
            if (L->left >= 0 && L->right >= 0 && L->Left()->sector == L->Right()->sector)
                continue;
...
static const char *unpack_confirm_message = "This map contains shared sidedefs.  It it recommended to unpack "
...
{
  public:
    UI_Check_Sectors(bool all_mode) : UI_Check_base(530, 346, all_mode, "Check : Sectors", "Sector test results")
    {
    }
...
check_result_e CHECK_Sectors(int min_severity = 0)
{
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 2, 220, "Show", &UI_Check_Sectors::action_show_unclosed, "Verts",
                            &UI_Check_Sectors::action_show_un_verts);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 2, 220, "Show", &UI_Check_Sectors::action_show_mismatch, "Lines",
                            &UI_Check_Sectors::action_show_mis_lines);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 2, 220, "Show", &UI_Check_Sectors::action_show_ceil, "Fix",
                            &UI_Check_Sectors::action_fix_ceil);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 2, 220, "Show", &UI_Check_Sectors::action_show_unknown, "Log",
                            &UI_Check_Sectors::action_log_unknown, "Clear", &UI_Check_Sectors::action_clear_unknown);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 1, 200, "Show", &UI_Check_Sectors::action_show_packed, "Unpack",
                            &UI_Check_Sectors::action_unpack);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 1, 170, "Remove", &UI_Check_Sectors::action_remove);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 1, 170, "Remove", &UI_Check_Sectors::action_remove_sidedefs);
        }
#endif
...
static bool TH_always_spawned(int type)
{
    ...
    // Polyobject things
    if (strstr(info->desc, "Polyobj") != NULL || strstr(info->desc, "PolyObj") != NULL)
        return true;

    // ambient sounds in Heretic and Hexen
    if (strstr(info->desc, "Snd") != NULL || strstr(info->desc, "Sound") != NULL)
        return true;
...
static void CollectBlockingThings(std::vector<int> &list, std::vector<int> &sizes)
{
    for (int n = 0; n < NumThings; n++)
    {
        const Thing *T = Things[n];
...
static bool ThingStuckInThing(const Thing *T1, const thingtype_t *info1, const Thing *T2, const thingtype_t *info2)
{
    SYS_ASSERT(T1 != T2);
    ...
    if ((info1->flags & THINGDEF_TELEPT) && is_actor2)
        return false;
    if ((info2->flags & THINGDEF_TELEPT) && is_actor1)
        return false;
...
{
  public:
    UI_Check_Things(bool all_mode) : UI_Check_base(520, 316, all_mode, "Check : Things", "Thing test results")
    {
    }
...
check_result_e CHECK_Things(int min_severity = 0)
{
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 2, 200, "Show", &UI_Check_Things::action_show_unknown, "Log",
                            &UI_Check_Things::action_log_unknown, "Remove", &UI_Check_Things::action_remove_unknown);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 2, 200, "Show", &UI_Check_Things::action_show_stuck);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 1, 200, "Show", &UI_Check_Things::action_show_void, "Remove",
                            &UI_Check_Things::action_remove_void);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_message, 1, 200, "Show", &UI_Check_Things::action_show_duds, "Fix",
                            &UI_Check_Things::action_fix_duds);
        }
#endif
...
void LineDefs_FindManualDoors(selection_c &lines)
{
    ...
    for (int n = 0; n < NumLineDefs; n++)
    {
        ...
        if (info->desc[0] == 'D' && (info->desc[1] == '1' || info->desc[1] == 'R'))
        {
            lines.set(n);
        }
    }
...
static int CheckLinesCross(int A, int B)
{
    ...
    if (MIN(AL->Start()->raw_y, AL->End()->raw_y) > MAX(BL->Start()->raw_y, BL->End()->raw_y))
    {
        return 0;
    }

    if (MIN(BL->Start()->raw_y, BL->End()->raw_y) > MAX(AL->Start()->raw_y, AL->End()->raw_y))
    {
        return 0;
    }
    ...
    if ((c_side == 0 && d_side == 0) || (e_side == 0 && f_side == 0))
    {
...
{
  public:
    UI_Check_LineDefs(bool all_mode) : UI_Check_base(530, 370, all_mode, "Check : LineDefs", "LineDef test results")
    {
    }
...
check_result_e CHECK_LineDefs(int min_severity)
{
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 2, 220, "Show", &UI_Check_LineDefs::action_show_zero, "Remove",
                            &UI_Check_LineDefs::action_remove_zero);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 2, 220, "Show", &UI_Check_LineDefs::action_show_overlap, "Remove",
                            &UI_Check_LineDefs::action_remove_overlap);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 2, 220, "Show", &UI_Check_LineDefs::action_show_crossing);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 1, 210, "Show", &UI_Check_LineDefs::action_show_unknown, "Log",
                            &UI_Check_LineDefs::action_log_unknown, "Clear", &UI_Check_LineDefs::action_clear_unknown);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 2, 300, "Show", &UI_Check_LineDefs::action_show_mis_right);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 2, 300, "Show", &UI_Check_LineDefs::action_show_manual_doors, "Fix",
                            &UI_Check_LineDefs::action_fix_manual_doors);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 1, 300, "Show", &UI_Check_LineDefs::action_show_lack_impass, "Fix",
                            &UI_Check_LineDefs::action_fix_lack_impass);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 1, 300, "Show", &UI_Check_LineDefs::action_show_bad_2s_flag, "Fix",
                            &UI_Check_LineDefs::action_fix_bad_2s_flag);
        }
#endif
...
static bool SEC_check_beast_mark(int tag)
{
    ...
    if (tag == 666)
    {
        ...
        // of a KEEN thing.
        if (y_stricmp(Level_name, "E1M8") == 0 || y_stricmp(Level_name, "E4M6") == 0 ||
            y_stricmp(Level_name, "E4M8") == 0 || y_stricmp(Level_name, "MAP07") == 0)
        {
            return true;
        }
...
class UI_Check_Tags : public UI_Check_base
{
  ...
  public:
    UI_Check_Tags(bool all_mode) : UI_Check_base(520, 326, all_mode, "Check : Tags", "Tag test results"), fresh_tag(0)
    {
    }
...
check_result_e CHECK_Tags(int min_severity)
{
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 2, 320, "Show", &UI_Check_Tags::action_show_missing_tag);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 2, 350, "Show", &UI_Check_Tags::action_show_unmatch_line);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 1, 350, "Show", &UI_Check_Tags::action_show_unmatch_sec);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 1, 350, "Show", &UI_Check_Tags::action_show_beast_marks);
        }
#endif
        ...
        if ((edit.mode == OBJ_LINEDEFS || edit.mode == OBJ_SECTORS) && edit.Selected->notempty())
        {
            ...
            dialog->AddGap(10);
#ifdef _FLTK_DISABLED
            dialog->AddLine("Apply a fresh tag to the selection", 0, 250, "Apply", &UI_Check_Tags::action_fresh_tag);
#endif
        }
...
static void bump_unknown_name(std::map<std::string, int> &list, const char *name)
{
...
static int check_transparent(const char *tex, std::map<std::string, int> &names)
{
...
void Textures_FindTransparent(selection_c &lines, std::map<std::string, int> &names)
{
    lines.change_type(OBJ_LINEDEFS);
    ...
    for (int n = 0; n < NumLineDefs; n++)
    {
        ...
        {
            // note : plain OR operator here to check all parts (do NOT want
            // short-circuit)
            if (check_transparent(L->Right()->LowerTex(), names) | check_transparent(L->Right()->UpperTex(), names) |
                check_transparent(L->Left()->LowerTex(), names) | check_transparent(L->Left()->UpperTex(), names))
            {
                lines.set(n);
            }
        }
...
void Textures_FindMedusa(selection_c &lines, std::map<std::string, int> &names)
{
    lines.change_type(OBJ_LINEDEFS);
...
void Textures_FindUnknownTex(selection_c &lines, std::map<std::string, int> &names)
{
    ...
    for (int n = 0; n < NumLineDefs; n++)
    {
        ...
        for (int side = 0; side < 2; side++)
        {
            ...
            {
                const char *tex = (part == 0) ? SD->LowerTex() : (part == 1) ? SD->UpperTex() : SD->MidTex();
...
void Textures_FindUnknownFlat(selection_c &secs, std::map<std::string, int> &names)
{
    secs.change_type(OBJ_SECTORS);
...
static bool is_switch_tex(const char *tex)
{
    ...
    return (tex[0] == 'S') && (tex[1] == 'W') && (tex[2] == '_' || isdigit(tex[2]));
}
...
{
  public:
    UI_Check_Textures(bool all_mode) : UI_Check_base(580, 286, all_mode, "Check : Textures", "Texture test results")
    {
    }
...
check_result_e CHECK_Textures(int min_severity)
{
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 2, 200, "Show", &UI_Check_Textures::action_show_unk_tex, "Log",
                            &UI_Check_Textures::action_log_unk_tex, "Fix", &UI_Check_Textures::action_fix_unk_tex);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 2, 200, "Show", &UI_Check_Textures::action_show_unk_flat, "Log",
                            &UI_Check_Textures::action_log_unk_flat, "Fix", &UI_Check_Textures::action_fix_unk_flat);
        }
#endif
        ...
        if (!Features.medusa_fixed)
        {
            ...
            else
            {
                ...
                dialog->AddLine(check_buffer, 2, 200, "Show", &UI_Check_Textures::action_show_medusa, "Log",
                                &UI_Check_Textures::action_log_medusa, "Fix", &UI_Check_Textures::action_remove_medusa);
            }
#endif
        }
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 1, 275, "Show", &UI_Check_Textures::action_show_missing, "Fix",
                            &UI_Check_Textures::action_fix_missing);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 1, 275, "Show", &UI_Check_Textures::action_show_transparent, "Fix",
                            &UI_Check_Textures::action_fix_transparent, "Log",
                            &UI_Check_Textures::action_log_transparent);
        }
#endif
        ...
        else
        {
            ...
            dialog->AddLine(check_buffer, 1, 275, "Show", &UI_Check_Textures::action_show_dup_switch, "Fix",
                            &UI_Check_Textures::action_fix_dup_switch);
        }
#endif
...
void CHECK_All(bool major_stuff)
{
    ...
    if (no_worries)
    {
        DLG_Notify(major_stuff ? "No major problems." : "All tests were successful.");
    }
}
